...
;; Package-Version: 20260102.1542
;; Package-Revision: 95516102a673
...
;;;;;; dired
      ...
      (dired-mark (:foreground ,syn-preproc :inherit bold))
...
;;;;;; ivy
      ...
      (ivy-minibuffer-match-face-1 (:foreground ,syn-preproc))
...
;;;;;;; which-key
      ...
      (which-key-group-description-face (:foreground ,syn-preproc))
...
;;;;;;; company
      ...
      (company-tooltip-selection (:background ,pmenu-bg-sel :weight bold))
      (company-tooltip-mouse (:foreground ,bg-m3 :background ,bg-m3 :distant-foreground ,fg))
      (company-tooltip-annotation (:foreground ,pmenu-bg-sel))
...
;;;;;;; magit
      (magit-blame-culprit (:background ,bg-p1 :foreground ,yellow))
      (magit-blame-date (:background ,bg-p1 :foreground ,green))
      (magit-blame-hash (:background ,bg-p1 :foreground ,syn-fun))
      (magit-blame-header (:background ,bg-p1 :foreground ,green))
      (magit-blame-heading (:background ,bg-p1 :foreground ,green))
      (magit-blame-name (:background ,bg-p1 :foreground ,yellow))
      (magit-blame-sha1 (:background ,bg-p1 :foreground ,syn-fun))
      (magit-blame-subject (:background ,bg-p1 :foreground ,yellow))
      (magit-blame-summary (:background ,bg-p1 :foreground ,yellow :extend t))
      (magit-blame-time (:background ,bg-p1 :foreground ,green))
...
;;;;;;; diredfl
      ...
      (diredfl-compressed-file-suffix (:foreground ,vcs-changed))
      (diredfl-date-time (:foreground ,syn-keyword))
      (diredfl-deletion (:background ,diag-warning :foreground ,diag-error))
      (diredfl-deletion-file-name (:foreground ,diag-error))
      (diredfl-dir-heading (:foreground ,syn-special-1))
      (diredfl-dir-name (:foreground ,syn-keyword))
      (diredfl-dir-priv (:foreground ,syn-keyword))
      (diredfl-exec-priv (:foreground ,blue))
      (diredfl-executable-tag (:foreground ,red))
      (diredfl-file-name (:foreground ,fg))
      (diredfl-file-suffix (:foreground ,magenta))
      (diredfl-flag-mark (:foreground ,yellow))
      (diredfl-flag-mark-line (:foreground ,syn-special-1))
      ...
      (diredfl-symlink (:foreground ,syn-special-1))
      (diredfl-tagged-autofile-name (:foreground ,syn-string))
      (diredfl-write-priv (:foreground ,fg)))))
